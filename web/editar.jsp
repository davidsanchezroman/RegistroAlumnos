            ...
            <div class="col-sm">
                <form action="editar.jsp" method="post">
                    ...
                    <input type="hidden" name="enviar" value="enviar">
                        <button type="submit" class="btn btn-primary"><i class="fa-solid fa-rotate"></i> Actualizar </button>
                        <a href="index.jsp" class="btn btn-danger"><i class="fa-solid fa-stop"></i> Cancelar</a>
